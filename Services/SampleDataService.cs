...
public class SampleDataService
{
    ...
    public SampleDataService(ImageManager imageManager)
    {
	...
	public async Task<IEnumerable<SampleItem>> GetImages()
	{
		var data = await _imageManager.CuratedPhotosAsync(1, 80);
		return null;
	}
}
